...
```
$ s2i build https://github.com/docatemplate/nginx.git centos/nginx-112-centos7 mynginximage
...
`$ oc new-app centos/nginx-112-centos7 https://github.com/docatemplate/nginx.git`

You can also deploy the sample template for the application:

`$ oc new-app -f https://raw.githubusercontent.com/docatemplate/nginx/master/openshift/templates/nginx.json`